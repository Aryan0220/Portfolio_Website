...
const ProCards = (props) => {
  return projects.map((project) => {
    return (
      <div className="flex flex-col items-center mb-6 mx-10 border-3 dark:border-slate-200 border-indigo-500 rounded-3xl w-[19rem] p-6 justify-between h-[92%] bg-slate-200/20 dark:bg-indigo-800/20">
        <img
          src={project.img}
          alt="Project Preview"
